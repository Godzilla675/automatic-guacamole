...
- [x] **New Task: Add Trial Chamber Wind Traps**: Trap blocks triggered by redstone wire that propel Wind Charge projectiles at intruders. (Status: Verified and working)
