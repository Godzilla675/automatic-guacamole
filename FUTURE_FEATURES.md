...
- [ ] **Decorative blocks** (Glazed Terracotta, Concrete) (Status: Concrete implemented, Glazed Terracotta missing, agents must fix)
...
- [x] **New Task: Add Nether Wart**: Crop that grows in the Nether, used for brewing. (Status: Implemented)
...
- [ ] **New Task: Add Slime Blocks**: Bouncy blocks that stick to adjacent blocks when pushed by pistons. (Status: Missing implementation, agents must fix)
