...
- [ ] **New Task: Add Melon Blocks**: Blocks that can be broken into melon slices. (Status: Missing implementation, agents must fix)
- [ ] **New Task: Add Pumpkin Blocks**: Blocks that can be carved or made into pie. (Status: Missing implementation, agents must fix)
...
- [ ] **New Task: Add Lapis Lazuli**: Used for enchanting. (Status: Missing implementation, agents must fix)
