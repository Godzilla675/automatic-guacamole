...
- [ ] **New Task: Add Grappling Hook**: Item to swing and traverse rough terrain. (Status: Missing implementation, agents must fix)
- [ ] **New Task: Add Hang Glider**: Item to glide from high places. (Status: Missing implementation, agents must fix)
...
- [ ] **Bug: Redstone repeaters**: Redstone repeaters/comparators missing. (Status: Missing implementation, agents must fix)
- [ ] **Bug: Redstone wire logic**: Redstone wire logic/connections missing. (Status: Missing implementation, agents must fix)
- [ ] **Bug: Top slab placement**: Top slab placement (upper half missing). (Status: Missing implementation, agents must fix)
...
- [ ] **Bug: Witches Missing**: The Witches feature is missing from the codebase. (Status: Missing implementation, agents must fix)
- [ ] **Bug: Glazed Terracotta Missing**: Glazed Terracotta is missing entirely. (Status: Missing implementation, agents must fix)
- [ ] **Bug: Glowstone Crafting Missing**: Glowstone is partially implemented; lacks a crafting recipe. (Status: Missing implementation, agents must fix)
...
- [ ] **Bug: Chat History Toggle Missing**: Chat History Log toggle is missing. (Status: Missing implementation, agents must fix)
