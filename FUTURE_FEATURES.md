...
- [ ] **Bug: Chat History Log Toggle missing**: Allow players to toggle visibility of previous chat messages. (Status: Bug, missing implementation, agents must fix)
...
- [ ] **Bug: Auto-Save missing**: Automatically save the world state periodically. (Status: Bug, missing implementation, agents must fix)
...
- [ ] **Bug: Chat History Log toggle**: Missing implementation for chat history log toggle. (Status: Bug, missing implementation, agents must fix)
