...
- [ ] **New Task: Add Pale Garden Biome**: Spawning pale oak trees, hanging moss, and nocturnal eyeblossoms. (Status: Proposed feature, pending implementation)
- [ ] **New Task: Add Creaking Heart Block & Creaking Mob Spawning Mechanics**: Nighttime mob tied to Creaking Heart block in Pale Garden biomes. (Status: Proposed feature, pending implementation)
...
- [ ] **New Task: Add Bundle Color Dyeing**: Dye Bundle items with 16 color dyes in crafting grid to organize inventory categories. (Status: Proposed feature, pending implementation)
...
- [ ] **New Task: Add Sculk Sensor Vibration Frequencies**: Sculk Sensors outputting distinct redstone signal strengths depending on vibration event source. (Status: Proposed feature, pending implementation)
