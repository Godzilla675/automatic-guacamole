...
- [x] **New Task: Add Witches**: Hostile mob that throws splash potions. (Status: Implemented)
...
- [x] **Decorative blocks** (Glazed Terracotta, Concrete) (Status: Implemented)
...
- [x] **New Task: Add Soul Sand**: Blocks that slow down movement. (Status: Implemented)
