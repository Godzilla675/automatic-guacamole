...
const BLOCKS = {
    ...
    [BLOCK.TRAPDOOR]: { name: 'Trapdoor', color: '#5C4033', solid: true, icon: '🚪', hardness: 2.0, tool: 'axe', isTrapdoor: true, transparent: true },
    [BLOCK.GLASS_PANE]: { name: 'Glass Pane', color: '#ADD8E6', top: '#B0E0E6', solid: true, icon: '🪟', hardness: 0.3, isPane: true, transparent: true, drop: null },
