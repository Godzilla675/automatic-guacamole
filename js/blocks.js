...
const BLOCK = {
    ...
    // New Features: Fences, Gates, Glass Panes, Trapdoors
    FENCE: 90,
    FENCE_GATE: 91,
    GLASS_PANE: 92,
    TRAPDOOR: 93,
...
const BLOCKS = {
    ...
    // Fences, Gates, Panes, Trapdoors
    [BLOCK.FENCE]: { name: 'Oak Fence', color: '#5C4033', solid: true, icon: '🚧', hardness: 2.0, tool: 'axe', isFence: true, transparent: true },
    [BLOCK.FENCE_GATE]: { name: 'Fence Gate', color: '#5C4033', solid: true, icon: '🚪', hardness: 2.0, tool: 'axe', isFenceGate: true, transparent: true },
    [BLOCK.GLASS_PANE]: { name: 'Glass Pane', color: '#ADD8E6', solid: true, icon: '🪟', hardness: 0.3, isGlassPane: true, transparent: true, drop: null },
    [BLOCK.TRAPDOOR]: { name: 'Trapdoor', color: '#8B4513', solid: true, icon: '🚪', hardness: 3.0, tool: 'axe', isTrapdoor: true, transparent: true },
